...
module top_inference_de1 (
    ...
    // Latch the final output when complete to keep HEX/LEDs stable
    logic signed [31:0] o0_latched;
    ...
    // Instantiate inference (single neuron variant)
    inference #(
    ...
    // Drive LEDs with lower 10 bits of latched o0 after delay; else blank
    assign LEDR = display_en ? o0_latched[9:0] : 10'b0;
...
//    endfunction
    ...
    // Show integer part (bits 31:16) on HEX3..HEX0 (nibbles) after delay; else blank
//    assign HEX0 = display_en ? hex7(o0_latched[11:8]) : 7'b1111111;
//    assign HEX1 = display_en ? hex7(o0_latched[15:12]) : 7'b1111111;
//    assign HEX2 = display_en ? hex7(o0_latched[19:16]) : 7'b1111111;
//    assign HEX3 = display_en ? hex7(o0_latched[23:20]) : 7'b1111111;
//    // Show fractional part (bits 15:8) on HEX5..HEX4 after delay; else blank
//    assign HEX4 = display_en ? hex7(o0_latched[27:24]) : 7'b1111111;
//    assign HEX5 = display_en ? hex7(o0_latched[31:28]) : 7'b1111111;

//	 assign HEX0 = display_en ? hex7(y[11:8]) : 7'b1111111;
//    assign HEX1 = display_en ? hex7(y[15:12]) : 7'b1111111;
//    assign HEX2 = display_en ? hex7(y[19:16]) : 7'b1111111;
//    assign HEX3 = display_en ? hex7(y[23:20]) : 7'b1111111;
//    // Show fractional part (bits 15:8) on HEX5..HEX4 after delay; else blank
//    assign HEX4 = display_en ? hex7(y[27:24]) : 7'b1111111;
//    assign HEX5 = display_en ? hex7(y[31:28]) : 7'b1111111;
